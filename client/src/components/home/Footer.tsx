...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary pt-16 text-white">
      <div className="container mx-auto max-w-335 px-6 lg:px-12">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-5 text-center sm:text-left">
            ...
            >
              <img
                src="https://harmless-tapir-303.convex.cloud/api/storage/9bbc4580-b5a6-4ca8-8a01-85b296a3f191"
                ...
                <li key={item.label}>
                  ...
                  >
                    <span className="flex items-center gap-3">
                      <span className="h-2 w-2 rounded-full bg-linear-to-r from-amber-200 via-pink-300 to-purple-400 animate-pulse" />
                      {item.label}
                    </span>
          ...
          <div className="col-span-full mt-8 space-y-6 text-sm text-white/80">
            <p className="text-xs font-bold uppercase tracking-[0.5em] text-white/60 text-center">
              Visit & Connect
            </p>
            <div className="rounded-3xl bg-white/5 p-9 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-5">
              <div>
                <p className="text-xs uppercase tracking-[0.4em] text-amber-200/70 mb-2">
                  Address
                </p>
        ...
        <div className="mt-16 border-t border-white/15 py-8 text-center text-[0.7rem] uppercase tracking-[0.4em] text-white/60">
          <p>© Mili Resorts 2024 · All Rights Reserved</p>
          <p className="mt-2">
            Develop & Maintain by Roy Informatics Pvt. Ltd.
          </p>
        </div>
      </div>
    </footer>
