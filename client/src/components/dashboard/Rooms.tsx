...
//   //   try {
//   //     const roomIds: string[] = selectedRooms.flatMap((room) =>
//   //       Array(room.quantity).fill(room._id)
//   //     );
...
//       return Array(qty).fill(room._id);
//     });
...
//     if (!checkIn || !checkOut || !bookingDetails) {
//       alert("Please complete booking dates.");
//       return;
//     }
